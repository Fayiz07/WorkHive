    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingEmployee) {
                ...
                // Create employee with the user data
                ...
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleSubmit}>
                            {!editingEmployee && (
                                <>
                                    <div className="form-row"><input type="text" name="username" placeholder="Username" value={formData.username} onChange={handleChange} required /></div>
